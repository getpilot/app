...
--> statement-breakpoint
ALTER TABLE "user" ADD COLUMN "main_offering" text;--> statement-breakpoint
ALTER TABLE "user" ADD COLUMN "sidekick_onboarding_complete" boolean DEFAULT false;--> statement-breakpoint
...
ALTER TABLE "user_offer_link" ADD CONSTRAINT "user_offer_link_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
