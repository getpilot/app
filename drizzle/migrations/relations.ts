...
import { contact, contactTag, user, account, session, instagramIntegration, userOffer, userToneProfile, userOfferLink, userFaq, sidekickActionLog, sidekickSetting } from "./schema";
...
export const userToneProfileRelations = relations(userToneProfile, ({one}) => ({
	user: one(user, {
...
export const sidekickActionLogRelations = relations(sidekickActionLog, ({one}) => ({
	user: one(user, {
...
export const sidekickSettingRelations = relations(sidekickSetting, ({one}) => ({
	user: one(user, {
