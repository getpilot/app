...
export function WaitlistWrapper({
  ...
  return (
    ...
    >
      ...
      <footer className="border-t border-neutral-200/50 dark:border-neutral-800/80 flex justify-between items-center w-full self-stretch px-8 py-3 text-sm bg-neutral-50/70 dark:bg-neutral-800/20 overflow-hidden">
