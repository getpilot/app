  ...
  return (
    <div
      className={clsx(
        ...
        "border border-gray-200/50 dark:border-neutral-800/80",
        className
      )}
    >
      ...
      <footer className="border-t border-gray-200/50 dark:border-neutral-800/80 flex justify-between items-center w-full self-stretch px-8 py-3 text-sm bg-gray-50/50 dark:bg-neutral-900/80 overflow-hidden">
